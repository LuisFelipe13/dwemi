...
var _groupsActions = __webpack_require__(26);
...
//POST a group/groups
store.dispatch((0, _groupsActions.postGroups)([{
  id: 1,
  name: 'Roomates',
  fund: [{
    name: "Couch",
...
// DELETE a group
store.dispatch((0, _groupsActions.deleteGroups)({ id: 1 }));
// UPDATE a group
store.dispatch((0, _groupsActions.updateGroups)({
  id: 2,
  name: 'Family'
}));
...
var _groupsReducers = __webpack_require__(25);

//HERE COMBINE THE REDUCERS
exports.default = (0, _redux.combineReducers)({
  groups: _groupsReducers.groupsReducers
});
...
exports.groupsReducers = groupsReducers;

function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

//GROUPS REDUCERS
function groupsReducers() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    groups: []
  };
  var action = arguments[1];
  ...
  switch (action.type) {
    ...
    case "UPDATE_GROUP":
      ...
      var newGroupToUpdate = _extends({}, currentGroupToUpdate[indexToUpdate], {
        ...
        groups: [].concat(_toConsumableArray(currentGroupToUpdate.slice(0, indexToUpdate)), [newGroupToUpdate], _toConsumableArray(currentGroupToUpdate.slice(indexToUpdate + 1)))
      };
  }
  return state;
}
